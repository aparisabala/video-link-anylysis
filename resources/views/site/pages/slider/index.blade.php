        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="mb-2">
                        <img src="{{url('images/system/sld_img_one.jpg')}}" class="img-fluid" />
                    </div>
                    <h5 style="color: #63D763"> 评论成功 </h5>
                    <div class="mb-2">
                        <img src="{{url('images/system/sld_img_two.jpg')}}" class="img-fluid" />
                    </div>
                    ...
                    <div class="mb-2">
                        <img src="{{url('images/system/sld_image_three.jpg')}}" class="img-fluid" />
                    </div>
